...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.indicator_circle_white;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.indicator_circle_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_animator,
                R.animator.scale_with_alpha);
        mAnimatorReverseResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_animator_reverse, 0);
        mIndicatorBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_icon_selected,
                        R.drawable.indicator_circle_white);
        mIndicatorUnselectedBackgroundResId =
                typedArray.getResourceId(R.styleable.CircleIndicator_icon_unselected,
                        mIndicatorBackgroundResId);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.indicator_circle_white, R.drawable.indicator_circle_white);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.indicator_circle_white
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
